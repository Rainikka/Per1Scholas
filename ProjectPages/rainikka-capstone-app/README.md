...
NYC Community Schools Data Dashboard (2018 - 2025) created with MERN (Mongo.db, Express, React.js, Node.js):
...
### Frontend Creation & Dependencies
...
- School Schema: All variables of school data
- Admin Schema: Form for :

### Three Routes:

- Schools: School Data
- District Administrator: - Capabilities: Create, Read, Update, & Delete
- General Public User: GET all or GET data on one school

## Four Pages:

- Home Page:About
- Admin: Form to perform CRUD
- Data dashboard on two pages

#### Data Dashboard 1

Page with school demographic data, attendance data and NYC map with school location starred

#### Data Dashboard 1

- Selector with each schools as an option auto-populates on and auto-populates each dashboard
- Page with school achievement data on ELA and Math from 2018-2024 (No data for COVID years 2020, 2021)
...
- Backend:Coding the backend is formulaic--like following the steps of a recipe--not any real diversions or choices to make --except for modeling the schemas. .Based on this, I have a healthy understanding of the backend.

- Frontend: From watching several videos on creating data dashboards with REact, I attempted to create one myself with CRUD capabilities. My learning of core concepts of this class has been coding along with videos that are slightly more advanced than my skill level to stretch my understanding. Unfortunately, that is what I attempted with the final project and not only did my knowledge of React not deepen, but I am still bewilder by it. All that to say,

## Challenges

- Knowledge gaps in understanding
- Project vision beyond current skill level
- Too many variables
  -React,
- Making the School's DBN the unique identifier in which to search and access individual schools.
- Admin Authorization
...
- Title: API Tutorial
- Creator: Coding Cleverly for Free Code Camp
...
- Creator: Chart.js
- Access Location: Creator White Paper Documentation on Google
